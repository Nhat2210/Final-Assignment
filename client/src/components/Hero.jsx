...
const Hero = () => {
  ...
  const onSearch = async (e) => {
    ...
    setSearchedCities((prevSearchCitites) => {
      const updatedSearchedCities = [...prevSearchCitites, destination];
  ...
  return (
    <div className=" flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 xl:px-32 text-white bg-[url('/src/assets/heroImage.png')] bg-no-repeat bg-cover bg-center h-screen">
      <p className="bg-[#49B9FF]/50 px-3.5 py-1 rounded-full mt-20">
        Trải Nghiệm Khách Sạn Đỉnh Cao
      </p>
      <h1 className="font-playfair text-2xl md:text-5xl md:text-[56px] md:leading-[56px] font-bold md:font-extrabold max-w-xl mt-4">
        Khám Phá Điểm Đến Hoàn Hảo Của Bạn
      </h1>
      <p className="max-w-130 mt-2 text-sm md:text-base">
        Sự sang trọng và thoải mái vô song đang chờ đón bạn tại những khách sạn
        và khu nghỉ dưỡng độc quyền nhất thế giới. Bắt đầu hành trình của bạn
        ngay hôm nay.
      </p>
      <form
        onSubmit={onSearch}
